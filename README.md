...
<img width="645" height="407" alt="Screenshot 2026-05-11 at 08 06 44" src="https://github.com/user-attachments/assets/9b217d39-32d2-4a8a-a152-6be5a7f1336d" />

<img width="446" height="403" alt="Screenshot 2026-05-11 at 08 07 08" src="https://github.com/user-attachments/assets/f11c4dad-8620-4d2c-bb37-d97b66aa2055" />

<img width="645" height="407" alt="Screenshot 2026-05-11 at 08 07 15" src="https://github.com/user-attachments/assets/33ca1053-e0cb-4f28-a73b-f77c286c76f1" />

<img width="540" height="365" alt="Screenshot 2026-05-11 at 08 07 23" src="https://github.com/user-attachments/assets/ec2dfe41-1922-49b1-b62e-2d01b763d0f4" />
...
|----------------------:|------:|--------------:|--------------:|--------|
| 10                    | 14    | 30 542 ns     | 23 750 ns     | DFS    |
| 30                    | 40    | 48 833 ns     | 38 875 ns     | DFS    |
| 100                   | 134   | 158 708 ns    | 134 917 ns    | DFS    |
...
- For all graphs (10, 30 and 100 vertices), **DFS was faster**. DFS tends to have lower overhead because it processes vertices more directly via a stack without the extra bookkeeping that a queue requires.
...
── Analysis ──
  ...
  Size 100: DFS was faster by 23 791 ns
```
